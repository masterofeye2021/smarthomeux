...
/**
 * @brief Module for handling light control events.
 */
@Slf4j
public class LightFullModule extends ModuleTemplate {

    /**
     * @brief Constructor for LightFullModule.
     * @param service The OpenhabItemService instance.
     * @param template The SimpMessagingTemplate instance.
     */
    public LightFullModule(int deviceID, int amountOfChannels, OpenhabItemService service, SimpMessagingTemplate template) {
