...
/**
 * @brief Module for handling door access events.
 * @binding This module uses the EKEY binding.
 *          https://www.openhab.org/addons/bindings/ekey/
 */
@Slf4j
public class DoorAccessModule extends ModuleTemplate {

    /**
     * @brief Constructor for DoorAccessModule.
     * @param service The OpenhabItemService instance.
     * @param template The SimpMessagingTemplate instance.
     */
    public DoorAccessModule(int deviceID, int amountOfChannels, OpenhabItemService service, SimpMessagingTemplate template) {
