...
/**
 * @brief Module for handling shutter control events.
 */
@Slf4j
@Data
public class ShutterModule extends ModuleTemplate {
    ...
    /**
     * @brief Constructor for ShutterModule.
     ...
     */
    public ShutterModule(int deviceID, int amountOfChannels, OpenhabItemService service, SimpMessagingTemplate template) {
